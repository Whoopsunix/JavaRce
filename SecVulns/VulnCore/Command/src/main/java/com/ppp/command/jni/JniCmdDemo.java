...
public class JniCmdDemo {
     ...
     * load命令执行类名
     */
    private static final String COMMAND_CLASS_NAME = "com.ppp.command.jni.Calc";

    /**
     * com.ppp.command.jni.Calc 类的字节码
    ...
    public void run(String cmd) {
        try {
             ...
             */
            // 获取项目目录
            File libPath = new File(System.getProperty("user.dir") + "/SecVulns/VulnCore/Command/src/main/java/com/ppp/command/jni/com/ppp/command/jni/libcmd.jnilib");
            /**
             * load命令执行类
             */
