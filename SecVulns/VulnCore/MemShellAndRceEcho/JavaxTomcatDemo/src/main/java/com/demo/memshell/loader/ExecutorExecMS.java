 ...
 * @author Whoopsunix
 */
public class ExecutorExecMS implements InvocationHandler {
    private static String HEADER = "Xoken";
    private Object targetObject;

    public ExecutorExecMS() {
    }

    public ExecutorExecMS(Object targetObject) {
    ...
    public void run(Runnable command) throws Exception {
        try {
